...
RequestUrl = ""
if fetch_latest:
    RequestUrl = "https://api.github.com/repos/pfpsim/PFPSim/releases/latest"
else:
    RequestUrl = "https://api.github.com/repos/pfpsim/PFPSim/releases/tags/" + tag_name
...
if not args.source:
    ...
    package_name = "pfpsimsource.tar.gz"
